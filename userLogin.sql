...
CREATE TABLE IF NOT EXISTS `userlogin2`.`childdata` (
  ...
  `typeOfHappening` VARCHAR(45) NOT NULL COMMENT 'Milyen programot szeretne a szülő',
  `timeOfHappening` VARCHAR(45) NOT NULL COMMENT 'A nap melyik részében szeretne programot a szülő',
  `placeOfHappening` VARCHAR(45) NOT NULL COMMENT 'Milyen helyet részesít előnyben a szülő',
  `ID` INT NOT NULL,
  PRIMARY KEY (`childID`),
